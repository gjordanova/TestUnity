...
public class Brush : MonoBehaviour
{
    ...
    private void SetupRigidbody()
    {
        if (m_Rigidbody != null)
        {
            ...
            m_Rigidbody.isKinematic = true; // Start as kinematic
        }
    }
    ...
    {
        if (m_Rigidbody != null && m_GameManager != null)
        {
            m_Rigidbody.isKinematic = m_GameManager.currentPhase != GamePhase.GAME;
        }
    }
    ...
    public void CycleColors(bool _Cycle)
    {
        ...
        else if (m_CycleColorCoroutine != null)
        {
